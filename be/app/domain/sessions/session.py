...
class Session:
    def __init__(self, session_id: UUID, user_id: UUID, game_id: UUID, start_time: datetime, state: SessionStateEnum,
                 score: int, emotion_errors: Dict, max_errors: int, level_threshold: int, ratio: List[float],
    ...
    def end_session(self) -> None:
        ...
        child_progress = ChildProgress.load_progress(self.user_id, self.game_id)
    ...
    def check_emotion_errors(self, errors: Dict, emotion: str) -> bool:
    ...
    def calculate_ratio(self, errors: Dict) -> List[float]:
    ...
    def reset_emotion_errors(self, errors: Dict) -> None:
