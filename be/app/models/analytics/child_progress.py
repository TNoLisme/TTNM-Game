from sqlalchemy import Column, UUID, Integer, Float, TIMESTAMP, ARRAY, ForeignKey, String, UnicodeText
...
class ChildProgress(Base):
    ...
    review_emotions = Column(UnicodeText, nullable=False, default="[]")
