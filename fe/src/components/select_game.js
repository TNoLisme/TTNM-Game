...
const GAME_THUMBNAILS = {
    'ea2b5c7e-aec8-4f6e-a8bf-99d7b6a05dd8': '../../assets/images/recognize_emotion.png',    // Chiếc hộp cảm xúc
    '8573ebd6-23be-4ad9-bd4c-3794b1c4a4fa': '../../assets/images/game_click_4.png',    // Thám tử cảm xúc
    'e7b4826b-57ba-4569-953e-723da913d47c': '../../assets/images/game_click_3.png', // Cảm xúc đúng chỗ
    'ecefa8d8-b9f5-4d41-abf9-316e6b6cf25b': '../../assets/images/game_click_2.png',  // Xưởng lắp ghép cảm xúc
    'bbd1597f-02b1-4e20-b39b-31d27335d385': '../../assets/images/game_cv_2.png',     // Thử thách cảm xúc (CV2)
    '9b56e632-dd86-4868-9d74-e0c93125430a': '../../assets/images/gameCV.png',       // Câu chuyện trên khuôn mặt
};
