...
const GAME_THUMBNAILS = {
    '3bcb2108-721c-4a15-a585-31f3084ed000': '../../assets/images/recognize_emotion.png',    // Chiếc hộp cảm xúc
    'aacaf79e-e15e-42a9-a3d1-a522720d919b': '../../assets/images/game_click_4.png',    // Thám tử cảm xúc
    '08bbffbf-d147-4556-bccb-b7621cafbf15': '../../assets/images/game_click_3.png', // Cảm xúc đúng chỗ
    '33ecafaa-ec7e-40d2-9c67-ed0a29ac0051': '../../assets/images/game_click_2.png',  // Xưởng lắp ghép cảm xúc
    '61f5e09e-eefa-44c1-86e1-87dfceac3b8e': '../../assets/images/game_cv_2.png',     // Thử thách cảm xúc (CV2)
    'e05909f3-3dee-42a6-9a75-fd985b1bdf47': '../../assets/images/gameCV.png',       // Câu chuyện trên khuôn mặt
};

function getGameThumbnail(game) {
    const id = (game.game_id || '').toLowerCase();
    console.log('📡 [fetchgame] Fetching for gameId:', game.game_id);
    console.log('📡 [fetchgame] Fetching for gameId:', GAME_THUMBNAILS[id]);
